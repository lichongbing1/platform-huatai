...
public class ServletUtils {
    ...
    // 静态文件后缀
    private final static String[] staticFiles = StringUtils.split(PropertyConfigurerUtil
            .getString("web.staticFile"), ",");
    ...
    public static boolean isAjaxRequest(HttpServletRequest request) {
        ...
        Principal principal = (Principal) ShiroUtils.getSubject().getPrincipal();
